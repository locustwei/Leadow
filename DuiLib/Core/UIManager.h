...
public:
	...
	void AddStyleAttributeList(LPCTSTR pStrControlName, LPCTSTR pStrControlAttrList, bool bShared);
	LPCTSTR GetDefaultAttributeList(LPCTSTR pStrControlName) const;
	LPCTSTR GetStyleAttributeList(LPCTSTR pStrControlName) const;
