...
//interface WJS_API IWJMftSearchDeleteHandler : public IWJSHandler
//{
//	virtual VOID  OnMftFileInfo(IWJMftFileRecord*, TCHAR*, PVOID) = 0;
//};
...
//{
//	virtual UINT GetFileFullname(UINT64, TCHAR*, UINT) = 0;
//	virtual VOID  Close() = 0;
//};

interface IWJMftReader
{
...
interface WJS_API IWJLibInterface
{
	...
	//virtual IWJMftIndexFile* CreateIndexFile(IWJVolume*, const TCHAR* Filename, IWJSHandler*) = 0;
};