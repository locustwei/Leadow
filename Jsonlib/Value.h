...
namespace JsonBox {
	...
	public:
		...
		Value(int newInt) : type(INTEGER), data(new int64_t(newInt)) {};
		Value(unsigned int newInt) : type(INTEGER), data(new int64_t(newInt)) {};
		Value(short newInt) : type(INTEGER), data(new int64_t(newInt)) {};
		Value(unsigned short newInt) : type(INTEGER), data(new int64_t(newInt)) {};
		 ...
		 * contain a numeric value.
		 */
		int64_t tryGetInteger(int defaultValue) const;
